// Identifires, Literal, Operator

var a = 10;
a = 20;
console.log(a);

// Variable name = Identifire - a (name given to the container)
// 10 -> Varaiable Value = Literal -> 10, 20 , "Hello", true, false, null, undefined
// = -> Operator

var a1 = 10;
console.log(a1);

// Comments , Identifires , Literals , Operator
